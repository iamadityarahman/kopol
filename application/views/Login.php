...
<html lang="en">
    <head>
        ...
        <style>
            body {
                background-image: url('<?=base_url()?>assets/img/background-login.jpg');
                background-size: 100%;
            ...
            .logingin {
                background-image: url('<?=base_url()?>assets/img/background-transparent.png');
