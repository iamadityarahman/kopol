...
<title>ANGGOTA | <?=$title?></title>

<!-- Tell the browser to be responsive to screen width -->
<meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">

<!-- Bootstrap 3.3.7 -->
<link rel="stylesheet" href="<?=base_url()?>assets/plugins/bootstrap-3.3.7-dist/css/bootstrap.min.css">
...
)?>assets/plugins/DataTables-1.10.16/css/dataTables.bootstrap.min.css"/>
